...
//        [HttpGet]
//        public JsonResult LoadDepts()
//        {
//            var department = db.Departments
//                .Select(m => new { value = m.DepartmentId, text = m.DepartmentName }).ToList();
//            return new JsonResult { Data = department, JsonRequestBehavior = JsonRequestBehavior.AllowGet };
...
//        {
//            IPagedList<MainService> MainServiceList = db.MainServices.OrderBy(c => c.MainServiceId).ToList().ToPagedList(page ?? 1, 2);
//            return View(MainServiceList);
//        }
//        [HttpPost]
//        public ActionResult SaveService(string id, string departmentid, string servicetimeid, string mainservicename, ServiceRequirement[] reqs)
//        {
//            // New Entry
//            if (string.IsNullOrEmpty(id))
//            {
//                if (!string.IsNullOrEmpty(mainservicename.Trim()) && !string.IsNullOrEmpty(servicetimeid.Trim()) && !string.IsNullOrEmpty(departmentid.Trim()) && reqs != null)
//                {
...
//                mainserviceGuidInDb.DepartmentId = departmentid;
...
//                DepartmentId = mainservicedetails.DepartmentId,
